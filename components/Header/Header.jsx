   ...
   <header>
    <nav className="navbar navbar-expand-lg navigation fixed-top" id="navbar">
     <div className="container">
      <a className="navbar-brand d-flex align-items-center" href="/#heroBanner">
       <img src="images/logo.jpg" alt="" className="img-fluid" />
       <p className='logo-title mb-0 p-0'>ZA Mentorship</p>
      </a>
      ...
      <div className={`collapse navbar-collapse ${isNavOpen ? 'show' : ''}`} id="navbarmain">
       <ul className="navbar-nav ml-auto">
        ...
        <li className="nav-item"><a className="nav-link" href="/#appoinment">Booking</a></li>
       </ul>
      </div>
     </div>
    </nav>
